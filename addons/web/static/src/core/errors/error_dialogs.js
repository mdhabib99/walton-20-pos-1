...
ErrorDialog.title = _lt("WALTON Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("WALTON Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("WALTON Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("WALTON Server Error");
                break;
            case "script":
                this.title = this.env._t("WALTON Client Error");
                break;
            case "network":
                this.title = this.env._t("WALTON Network Error");
                break;
        }
    }
...
export class WarningDialog extends Component {
    ...
    inferTitle() {
        ...
        return this.props.title || this.env._t("WALTON Warning");
    }
}
...
export class RedirectWarningDialog extends Component {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("WALTON Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("WALTON Session Expired");
