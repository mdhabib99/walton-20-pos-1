...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        ('inbox', 'Handle in WaltonBot') # if need chat in future
        ],
        'Notification', required=True, default='email',
        compute='_compute_notification_type', store=True, readonly=False,
        help="Policy on how to handle Chatter notifications:\n"
             "- Handle by Emails: notifications are sent to your email address\n"
             "- Handle in WaltonBot: notifications appear in your WaltonBot Inbox")
    ...
    _sql_constraints = [(
        ...
        "Only internal user can receive notifications in WaltonBot",
    )]
