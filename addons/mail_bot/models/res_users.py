...
class Users(models.Model):
    ...
    odoobot_state = fields.Selection(
        [
            ...
            ('idle', 'Idle'),
            ('disabled', 'Disabled'),
        ], string="WaltonBot Status", readonly=True, required=False)  # keep track of the state: correspond to the code of the last message sent
    ...
    def _init_odoobot(self):
        ...
        message = _("Hello,<br/>WaltonBot chat helps employees collaborate efficiently. I'm here to help you discover its features.<br/><b>Try to send me an emoji</b> <span class=\"o_odoobot_command\">:)</span>")
