...
class Partner(models.Model):
    ...
    vat = fields.Char(string='Tax Id/PAN/Trade Licence', index=True, help="The Tax Identification Number. Values here will be validated based on the country format. You can use '/' to indicate that the partner is not subject to tax.")
